...
class LinhaAcao(ctk.CTkFrame):
    ...
    def __init__(self, master, on_change, on_remove, default_resp="Escritório Externo", default_resp_free="", row_list_key="acao_rows"):
        ...
        ctk.CTkLabel(self, text="Tipo de ação:").grid(row=0, column=0, sticky="w", padx=(4, 6), pady=(4, 2))
        ctk.CTkComboBox(
            self,
            values=[
                "Acionar Tarefa",
    ...
    def _refresh(self):
        ...
        if t == "Acionar Tarefa":
            ...
            ctk.CTkLabel(self.frm_dyn, text="Dias:").grid(row=row, column=0, sticky="w", pady=(2, 2))
            IntSpin(
                self.frm_dyn,
                from_=0,
                to=365,
            ...
            ).grid(row=row, column=1, sticky="w", pady=(2, 2))
            row += 1
            ...
            self.chk_feriados.grid(row=row, column=1, sticky="w", pady=(2, 2))
            row += 1
